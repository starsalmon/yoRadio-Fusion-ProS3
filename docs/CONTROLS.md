## Controls (buttons / encoders / IR / touch)

This is the original upstream “Controls” block, kept verbatim as a reference. Actual behavior depends on your `myoptions.h` pin/feature configuration.
