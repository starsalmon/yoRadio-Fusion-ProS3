...
const ScrollConfig metaConf       PROGMEM = {{ TFT_FRAMEWDT, 5, 3, WA_LEFT }, 140, true, MAX_WIDTH, 5000, 7, 40 };
...
const ScrollConfig weatherConf    PROGMEM = {{ 10, 84, 2, WA_LEFT }, 140, false, MAX_WIDTH+20, 0, 3, 80 };
...
const BitrateConfig fullbitrateConf PROGMEM = {{DSP_WIDTH-TFT_FRAMEWDT-40, 130, 2, WA_LEFT}, 45 };

/* BANDS  */                             /* { onebandwidth, onebandheight, bandsHspace, bandsVspace, numofbands, fadespeed } */
const VUBandsConfig bandsConf     PROGMEM = { 45, 100, 6, 2, 8, 3 };

const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 105, 1, WA_LEFT };

const WidgetConfig  clockConf     PROGMEM = { TFT_FRAMEWDT+45, 203, 70, WA_RIGHT };  /* 52 is a fixed font size. do not change */
...
const MoveConfig    clockMove     PROGMEM = { TFT_FRAMEWDT+45, 203, -1 /* MAX_WIDTH */ }; // -1 disables move
